...
G4VPhysicalVolume* CfRPCDetectorConstruction::Construct() {
   ...
   //***************************************************
   G4Box* PEBottom = RPCBox("PEBottom", 0.025*cm) ;
   G4LogicalVolume* PEBottomLog = new G4LogicalVolume(PEBottom, G4NistManager::Instance()->FindOrBuildMaterial("G4_POLYETHYLENE"), "PEBottomLog") ;
   ...
   G4LogicalVolume* PETopLog = new G4LogicalVolume(PETop,G4NistManager::Instance()->FindOrBuildMaterial("G4_POLYETHYLENE") , "PETopLog") ;
