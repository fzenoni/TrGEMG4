...
// ********************************************************************
//
/// \file electromagnetic/TestEm8/src/TrGEMPhysicsList.cc
/// \brief Implementation of the TrGEMPhysicsList class
//
// $Id$
//
//---------------------------------------------------------------------------
//
// ClassName:   TrGEMPhysicsList
//
...
TrGEMPhysicsList::TrGEMPhysicsList() : G4VModularPhysicsList()
{
  ...
  fMessenger = new TrGEMPhysicsListMessenger(this);
