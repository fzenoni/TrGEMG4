...
// ********************************************************************
//
/// \file electromagnetic/TestEm8/src/TrGEMPhysicsListMessenger.cc
/// \brief Implementation of the TrGEMPhysicsListMessenger class
//
// $Id$
//
//---------------------------------------------------------------------------
...
#include "TrGEMPhysicsListMessenger.hh"
...
TrGEMPhysicsListMessenger::TrGEMPhysicsListMessenger(TrGEMPhysicsList* pPhys)
:fTrGEMPhysicsList(pPhys)
{   
...
TrGEMPhysicsListMessenger::~TrGEMPhysicsListMessenger()
{
  delete fECmd;
  delete fEBCmd;
  delete fCBCmd;
...
void TrGEMPhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{       
  ...
  if( command == fListCmd )
   { fTrGEMPhysicsList->AddTrGEMPhysicsList(newValue); }
}
