...
CrociDetectorConstruction::CrociDetectorConstruction() :
...
void CrociDetectorConstruction::DefineMaterials() {
...
G4VPhysicalVolume* CrociDetectorConstruction::Construct() {
   ...
   */
   ...
   G4Box* gasGap1A = GemBox("GasGap1A", 3.*mm) ;
   ...
   G4Box* gasGap2A = GemBox("GasGap2A", 3.*mm) ;
...
G4Trd* CrociDetectorConstruction::Trapezoid(G4String name, G4double width) {
...
G4Box* CrociDetectorConstruction::GemBox(G4String name, G4double width) {
...
void CrociDetectorConstruction::PlaceGeometry(G4RotationMatrix *pRot, G4ThreeVector tlate, G4LogicalVolume* pMotherLogical) {
