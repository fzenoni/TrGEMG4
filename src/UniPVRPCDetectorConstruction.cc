...
UniPVRPCDetectorConstruction::UniPVRPCDetectorConstruction() :
...
void UniPVRPCDetectorConstruction::DefineMaterials() {
...
G4VPhysicalVolume* UniPVRPCDetectorConstruction::Construct() {
   ...
   G4Box* pethylene0 = RPCBox("pethylene0", 0.03*cm) ;
   ...
   G4Box* pethylene3 = RPCBox("pethylene3", 0.03*cm) ;
...
G4Box* UniPVRPCDetectorConstruction::RPCBox(G4String name, G4double width) {
...
void UniPVRPCDetectorConstruction::PlaceGeometry(G4RotationMatrix *pRot, G4ThreeVector tlate, G4LogicalVolume* pMotherLogical) {
