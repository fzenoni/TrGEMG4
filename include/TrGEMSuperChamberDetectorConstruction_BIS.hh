#ifndef TrGEMSuperChamberDetectorConstruction_BIS_hh
#define TrGEMSuperChamberDetectorConstruction_BIS_hh
...
class TrGEMSuperChamberDetectorConstruction_BIS : public G4VUserDetectorConstruction
{
   public :
      // Constructor
      TrGEMSuperChamberDetectorConstruction_BIS() ;
      // Destructor
      ~TrGEMSuperChamberDetectorConstruction_BIS() ;
