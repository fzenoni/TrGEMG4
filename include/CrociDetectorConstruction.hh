#ifndef CrociDetectorConstruction_hh
#define CrociDetectorConstruction_hh
...
class CrociDetectorConstruction : public G4VUserDetectorConstruction
{
   public :
      // Constructor
      CrociDetectorConstruction() ;
      // Destructor
      ~CrociDetectorConstruction() ;
