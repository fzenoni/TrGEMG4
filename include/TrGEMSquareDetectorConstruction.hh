#ifndef TrGEMSquareDetectorConstruction_hh
#define TrGEMSquareDetectorConstruction_hh
...
class TrGEMSquareDetectorConstruction : public G4VUserDetectorConstruction
{
   public :
      // Constructor
      TrGEMSquareDetectorConstruction() ;
      // Destructor
      ~TrGEMSquareDetectorConstruction() ;
